...
module.exports = (router) => {
  ...
  router.route('/team/:team_idx')
    .get(AuthCtrl.auth, validate(ParamValidation.team_retrieve), TeamCtrl.retrieve); // 팀 메인페이지 조회
  ...
  router.route('/team/:team_idx/post')
    .get(AuthCtrl.auth, validate(ParamValidation.post_retrieve), PostCtrl.retrieve) // 담벼락 조회
